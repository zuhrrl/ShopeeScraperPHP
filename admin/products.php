...
<?php
 $page_subtitle = "Products"; // Subtitle contoh: Example | Subtitle
 $page_description ="A Powerfull Shopee Auto Content Generator"; // Description untuk meta
 $page_name = $page_subtitle." | Admin Panel";
 $title = $page_name;
      ...
      <div id='main-content' class='h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64'>
        <main>
          ...
          <textarea id='listkeywords' placeholder='Input keyword separated by breakline example: keyword [Enter] keyword [enter]'
                  rows='4'
                  class='hidden placeholder-gray-500 w-full bg-white rounded-md border border-gray-300 focus:border-indigo-600 focus:ring-2 focus:ring-indigo-200 text-sm outline-none text-gray-900 py-1 px-3 leading-8 transition-colors duration-150 ease-in-out'> </textarea>
...
$sql = "SELECT id, product_name, product_description, product_images, product_price, product_link, product_itemid, product_shopid, product_thumbnail,product_stock, product_rating, product_category, product_review_count, product_brand, product_aff_link FROM products ORDER BY id DESC LIMIT 30";
